...
const { getUser, getAllUsers, getAllUsersWithJobDetail, getOneUserWithJobDetail, getResume, getCoverLetter, getCerficate, getJobById } = require('../controller/user');
...
// Get jobs of user by id
router.get('/job/:jobId', isSignedIn, isAuthenticated, isAdmin, getJobById)
